...
![成本总览](img/v04-cost-overview.png)
...
| KPI 与图表 | 治理清单 |
|-----------|---------|
| ![成本 KPI](img/v04-cost-kpi.png) | ![治理清单](img/v04-cost-governance.png) |
...
| 摘要 | 明细与图表 |
|------|----------|
| ![账单摘要](img/v04-billing-summary.png) | ![账单明细](img/v04-billing-detail.png) |

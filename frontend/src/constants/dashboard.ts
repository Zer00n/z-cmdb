/**
 * Asset overview constants (single source of truth)
 * Network zone colors / dangerous port definitions etc., shared by Dashboard and future consumers
 */

/** Network zone -> display name */
...
/** Asset type / importance / OS color palettes */

"""
Department billing API (guarded by require_cost_feature)
...
def get_department_bill(
    dept_id: int,
    date_from: str = Query(..., alias="from", description="Billing start date YYYY-MM-DD"),
    date_to: str = Query(..., alias="to", description="Billing end date YYYY-MM-DD"),
    granularity: str = Query("month", description="Granularity: day/month/year"),
